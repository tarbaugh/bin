...
def write_mlip(positions, types, cells, forces, energy, stresses):
    with open('new_cfgs.cfg', 'a') as file:
        ...
        file.write("     {} {} {} {} {} {}".format(stresses[0], stresses[1], stresses[2], stresses[3], stresses[4], stresses[5]))
        file.write("END_CFG\n")
        file.write("\n")
